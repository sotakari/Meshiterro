...
・ユーザー情報に加えてユーザーが投稿したPostImageモデルの一覧も詳細ページに表示させる。<br>
...
・Favoriteモデルの作成<br>
・PostImageモデル、Userモデルに関連付ける<br>
・1人のユーザーが1つの投稿に対して重複していいねを押せないようにするためにバリデーションを設定する。<br>
・resourceでルーティングを設定する。<br>
・Controllerを作成し、ControllerとViewにいいね機能について記述する。

## 20章 共通のレイアウトを部分テンプレートでまとめよう

#### 部分テンプレートを利用するメリット
・記述するコードの量が減り、見やすくなる<br>
・同じ記述を何度も書く必要がなくなる<br>
・修正が必要な場合、修正の対象箇所を減らせる<br>
...
#### ページネーションとは
一つの長い文章を複数のページに分割し表示すること。<br>

ページネートすることによるメリット<br>
・読みやすくなる<br>
・ページの読み込み時間を短縮できる<br>
・検索で上位にヒットしやすくなる。<br>
...
ページネーションに必要な機能を効率的に提供するGem(ライブラリ)である。<br>
主な機能<br>
【ビューヘルパー】<br>
ページネーションのリンクを表示するためのHTMLコードを生成<br>
【メソッド】<br>
モデルのクエリをページネーションに対応する形式に変換する<br>
【クエリの最適化】<br>
取得数などのカスタマイズ<br>
